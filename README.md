...
![Version](https://img.shields.io/badge/version-1.2.3-0f766e)
...
- 詳細分析と創作ブリーフの固定文型を見直し、企画案ごとに画面の違和感、証言・会話のズレ、選択と回収の役割を分けるよう改善。
- 実名流入、破綻した係り受け、同一ブリーフ文型の繰り返しを検出する回帰テストを追加。

### v1.2.2 (2026-06-26)

- 制作判断チャート、詳細分析、ロードマップ、企画案、ブリーフ、設計メモ、冒頭例、執筆プロンプトを取得根拠語から再構成するよう修正。
...
- APIキー変更時に、古いAPI詳細分析、参考文章、取得根拠、チャート、企画案を即時リセットするよう修正。
